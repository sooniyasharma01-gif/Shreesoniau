import "./Intro.css";
import introImage from "../assets/GalleryImg/g8.jpeg";
...
import g21 from "../assets/GalleryImg/g21.jpeg";
import useScrollReveal from "../hooks/useScrollReveal";
import useParallax from "../hooks/useParallax";
import { NavLink } from "react-router-dom";
import Carousel from "../components/Carousel/Carousel";

const carouselImages = [g1, g2, g3, introImage, g5, g7, g9, g11, g13, g15, g17, g19, g21];
    ...
    <div className="intro-page">
      ...
      <div className="intro-hero">
        <div className="intro-text reveal reveal-left" ref={heroText}>
          ...
          <p className="signature">With warmth,<span>Shree Soni</span></p>
        </div>
      ...
      <div className="timeline-section reveal" ref={timeline1}>
        ...
        <h3 className="timeline-title">A Date With Shree Soni</h3>
      ...
      <div className="intro-info">
        <div className="info-image-side reveal reveal-left" ref={infoImg}>
          <img src={infoImage} alt="Shree Soni" ref={parallax2} className="parallax-img" onContextMenu={block} onDragStart={block} />
        ...
        <div className="info-text-side reveal reveal-right" ref={infoText}>
          ...
          <div className="info-grid">
            ...
            <div className="info-cell"><label>Languages</label>Hindi, English</div>
