  ...
  return (
    <div className="np-page">
      ...
      <div className="avail-notes reveal" ref={notes}>
        ...
        <div className="avail-note-item">
          <span>✈️</span>
          <p><strong>Travel:</strong> Available for travel within the Australia and international FMTY with sufficient notice.</p>
        </div>
        <div className="avail-note-item">
          <span>⚡</span>
          <p><strong>Schedule changes:</strong> Availability updates regularly — always confirm via direct message.</p>
        </div>
      </div>
